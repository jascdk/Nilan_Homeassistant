...
// WIFI settings
#define WIFISSID     "XXXXX" // Put in your SSID
#define WIFIPASSWORD "XXXXXXXX" // Put in you SSID Password
...
// MQTT settings
#define MQTTSERVER   "XXXXXXX // Put in the IP adresse of your MQTT broker
#define MQTTUSERNAME "XXXXX" // Username for the MQTT broker (NULL if no username is required)
#define MQTTPASSWORD "XXXXXXXX" // Passowrd for the MQTT broker (NULL if no password is required)
